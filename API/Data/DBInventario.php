...
class DBInventario {
    ...
    function agregarInventario($inventario){
        $db = new DB();
        $sql = "INSERT INTO inventario (FkIdSucursalBarberia, Producto,Codigo, CantidadDisponible, CantidadMinima, Precio, Costo,Marca, Ubicacion, Descripcion, Descuento, Impuesto, Proveedor, Categoria, Utilidad, Modelo, Estado, TipoDescuento, Unidad) VALUES ("
