...
var CitasComponent = (function () {
    ...
    CitasComponent.prototype.facturacionHacienda = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sucursal, user, barbero, usuarios;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!(this.nuevoUsuario.nombre != 'generico' && ((this.nuevoUsuario.nombre && this.nuevoUsuario.apellido1 && this.nuevoUsuario.apellido2) || this.nuevoUsuario.cedula))) return [3 /*break*/, 5];
                        ...
                        if (!(!this.nuevoUsuario.cedula && this.nuevoUsuario.nombre && this.nuevoUsuario.apellido1 && this.nuevoUsuario.apellido2)) return [3 /*break*/, 4];
